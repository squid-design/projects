module Jekyll
    ...
    class CategoryPager < Paginate::Pager
        ...
        # use the original to_liquid mehtod, but add in category info
        ...
        def pager_links(pager)
            ...
            if pager['previous_page'] || pager['next_page']
                ...
                if pager['previous_page']
                    ...
                    if pager['previous_page'] || pager['next_page']
                        html << "<div class=\"next\"><a href=\"/blogs/#{pager['category']}/\">Newer posts &raquo;</a></div>"
                    else
                        html << "<div class=\"next\"><a href=\"/blogs/#{pager['category']}/page#{pager['previous_page']}\">Newer posts &raquo;</a></div>"
                    end
                end

                if pager['next_page_path']
                    html << "<div class=\"previous\"><a href=\"/blogs/#{pager['category']}/page#{pager['next_page']}\">&laquo; Older posts</a></div>"
                end
